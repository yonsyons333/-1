...
# # *language는 가변인자, 즉 변수의 개수를 마음대로 조절할 수 있는 것
# # end=" "는 줄바꾼다
...
# checkpoint(2) #2명이 총을 가져감(경계근무 나감)
...
print("키 {0}cm는 {1}의 표준 체중은 {2}kg 입니다.".format(height, gender, weight)) 
...
'''
# # print("Python", "Java", "JavaScript", spec=" vs ")

# # print("Python", "Java", spec=" ", end ="?")
# print("무엇이 더 재밌을까요?")
모르겠음'''

# # "file=sys.stderr"이 적힌 부분에서 오류가 났을 때, 터미널에서 표시해준다
# import sys
...
# # 빈 자리는 빈공간으로 두고, 오른쪽 정렬응 하되, 총 10자리 공간을 확보
...
# # (왼쪽부터) ^로 빈자리 채우고(30-n),왼쪽정렬,+-표시하고,30자리 확보하고,3자리마다 ,표시하고
# print("{0:^<+30,}".format(1000000000000))
# # 소수점 출력
# print("{0:f}".format(5/3))
# # 소수점 특정 자리수 까지만 표시 (소수점 2째자리까지 표시,3째 자리에서 반올림)
...
# # "W"는 쓰기 또는 덮어쓰기를 의미하고, "a"는 이어쓰기를 의미한다
